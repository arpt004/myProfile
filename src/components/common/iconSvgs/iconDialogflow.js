...
// icon:dialogflow | Simple Icons https://simpleicons.org | SimpleIcons.org
import * as React from "react";

function IconDialogflow(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="#676767"
